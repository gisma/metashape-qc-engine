...
| `docs/LEVEL1B_METHOD_CORE_MAP.md` | Level-1B method core: valid mask, six-band RGB/DGLCM-PC1 proxy stack, scaling, scale distribution, ranger, perturbations, Step 9a/9b, Step 10 | active |
